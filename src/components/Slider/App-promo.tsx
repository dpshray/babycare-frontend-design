...
import {BABY_CARE_APP_STORE_URL, BABY_CARE_PLAY_STORE_URL} from "@/config/app-constant";
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                    <div className="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <p className="text-base md:text-lg text-gray-600 mb-6 md:mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
                            Parenting made easier. Download our app for safe baby products, timely vaccination
                            reminders,
                            healthcare access, and trusted guidance — all in one place.
                        </p>
                        <div
                            ...
                            >
                                ...
                                <div className="flex flex-col items-start">
                                    <span className="text-[10px] md:text-xs uppercase tracking-wide">Get it on</span>
                                    <span className="text-base md:text-lg font-bold leading-none">Google Play</span>
                                </div>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <div className="flex flex-col items-start">
                                    <span
                                        className="text-[10px] md:text-xs uppercase tracking-wide">Download on the</span>
                                    <span className="text-base md:text-lg font-bold leading-none">App Store</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div className="w-full lg:w-1/2 flex items-center justify-center">
                        <div
                            ...
                            <div
                                className="absolute inset-0 bg-gradient-to-br from-blue-400 to-purple-500 rounded-[2.5rem] blur-2xl opacity-20 transform scale-95"></div>
                            <Image
                                src="/app-promo.png"
